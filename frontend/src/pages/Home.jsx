        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-buttons">
              <Link to="/user/login" className="btn user-btn">
                <span>👤</span>
                User Login
      ...
      <section className="services-section" id="services">
        <div className="services-cards">
          <div className="service-card">
            ...
            <p>Register complaints, track requests, and get quick resolutions.</p>
          </div>
          <div className="service-card">
            <img src="/assets/service-mission.png" alt="Mission" />
            <h3>About Our Mission</h3>
            <p>Committed to creating a smart, sustainable, and responsive city.</p>
          </div>
          <div className="service-card">
            <img src="/assets/service-admin.png" alt="Admin Management" />
            <h3>Admin Management</h3>
            <p>Efficient tools for administrators to manage city operations.</p>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section" id="contact">
        <div className="cta-content">
          ...
          <div className="cta-text">
            ...
            <p>Enhance your city's services and be a part of positive change.</p>
