...
exports.sendStatusUpdateEmail = async (email, name, complaintData) => {
  try {
    ...
    const transporter = createTransporter();
    const statusColors = { Pending: "#f57c00", Assigned: "#1b6ca8", Resolved: "#059669", Cancelled: "#e63946" };
    const statusEmoji = { Pending: "⏳", Assigned: "🏢", Resolved: "✅", Cancelled: "❌" };
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
          ...
          <div style="background: #ffffff; padding: 28px;">
            ...
            <p style="font-size: 14px; color: #555; margin-bottom: 20px;">Your complaint has been updated:</p>
            <div style="text-align: center; margin-bottom: 24px;">
              <span style="background: ${color}; color: white; padding: 10px 24px; border-radius: 24px; font-size: 16px; font-weight: 700; display: inline-block;">${emoji} ${status}</span>
            </div>
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
              <tr style="background: #f8fafc;"><td style="padding: 10px 14px; font-size: 13px; color: #888; width: 40%; border-bottom: 1px solid #eee;">Complaint ID</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; color: #333; border-bottom: 1px solid #eee;">#${complaintId}</td></tr>
              <tr><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Type</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; color: #333; border-bottom: 1px solid #eee;">${type}</td></tr>
              <tr style="background: #f8fafc;"><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Area</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; color: #333; border-bottom: 1px solid #eee;">${area}</td></tr>
              <tr><td style="padding: 10px 14px; font-size: 13px; color: #888;">Status</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 700; color: ${color};">${emoji} ${status}</td></tr>
            </table>
            ${status === "Resolved" ? `<div style="background: #d1fae5; border-radius: 10px; padding: 14px 18px; margin-bottom: 20px;"><p style="margin: 0; color: #059669; font-size: 14px; font-weight: 600;">🎉 Your complaint has been resolved!</p></div>` : ""}
            <div style="text-align: center; margin-top: 20px;">
              <a href="${process.env.CLIENT_URL}/user/complaints" style="background: #0f4c75; color: white; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block;">View in Portal →</a>
            </div>
          </div>
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden;">
          ...
          <div style="background: white; padding: 28px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
              <tr style="background: #f8fafc;"><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Certificate ID</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; color: #333; border-bottom: 1px solid #eee;">#${certId}</td></tr>
              <tr><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Type</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; color: #333; border-bottom: 1px solid #eee;">${type} Certificate</td></tr>
              <tr style="background: #f8fafc;"><td style="padding: 10px 14px; font-size: 13px; color: #888;">Status</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 700; color: ${color};">${emoji} ${status}</td></tr>
            </table>
            ${status === "Approved" ? `<div style="background: #d1fae5; border-radius: 10px; padding: 14px 18px; margin-bottom: 20px;"><p style="margin: 0; color: #059669; font-weight: 600;">🎉 Approved! Collect from office within 3 working days.</p></div>` : status === "Rejected" ? `<div style="background: #ffe4e4; border-radius: 10px; padding: 14px 18px; margin-bottom: 20px;"><p style="margin: 0; color: #e63946; font-weight: 600;">Request rejected. Please reapply with correct documents.</p></div>` : ""}
            <div style="text-align: center;">
              <a href="${process.env.CLIENT_URL}/user/my-certificates" style="background: #0f4c75; color: white; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block;">View in Portal →</a>
            </div>
          </div>
          <div style="background: #f8fafc; padding: 16px 28px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #aaa;">Smart Municipal Corporation • Ahmedabad, Gujarat</p>
...
exports.sendCityUpdateEmail = async (email, name, updateData) => {
  try {
    ...
    const transporter = createTransporter();
    const categoryEmoji = { General: "🏙️", Road: "🛣️", Water: "💧", Park: "🌳", Event: "📅", Infrastructure: "🏗️" };
    const emoji = Object.entries(categoryEmoji).find(([key]) => title?.toLowerCase().includes(key.toLowerCase()))?.[1] || "🏙️";
    await transporter.sendMail({
      from: `"Smart Municipal Corporation" <${process.env.EMAIL_USER}>`,
      to: email,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden;">
          ...
          <div style="background: #ffffff; padding: 28px;">
            ...
            <div style="text-align: center;">
              <a href="${process.env.CLIENT_URL}/user/city-updates" style="background: #0f4c75; color: white; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block;">View in Portal →</a>
            </div>
          </div>
          <div style="background: #f8fafc; padding: 16px 28px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #aaa;">Smart Municipal Corporation • Ahmedabad, Gujarat</p>
        ...
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden;">
          ...
          <div style="background: #ffffff; padding: 28px;">
            ...
            <div style="text-align: center; margin-bottom: 20px;">
              <span style="background: ${color}; color: white; padding: 10px 24px; border-radius: 24px; font-size: 16px; font-weight: 700; display: inline-block;">${emoji} ${label}</span>
            </div>
            ...
            <div style="text-align: center;">
              <a href="${process.env.CLIENT_URL}/user/announcements" style="background: #1b6ca8; color: white; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block;">View Announcement →</a>
            </div>
          </div>
          <div style="background: #f8fafc; padding: 16px 28px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #aaa;">Smart Municipal Corporation • Ahmedabad, Gujarat</p>
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden;">
          ...
          <div style="background: white; padding: 28px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
              <tr style="background: #f8fafc;"><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Request ID</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; border-bottom: 1px solid #eee;">#${requestId}</td></tr>
              <tr><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Type</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; border-bottom: 1px solid #eee;">${type}</td></tr>
              <tr style="background: #f8fafc;"><td style="padding: 10px 14px; font-size: 13px; color: #888; border-bottom: 1px solid #eee;">Area</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 600; border-bottom: 1px solid #eee;">${area}</td></tr>
              <tr><td style="padding: 10px 14px; font-size: 13px; color: #888;">Status</td><td style="padding: 10px 14px; font-size: 13px; font-weight: 700; color: ${color};">${emoji} ${status}</td></tr>
            </table>
            <div style="text-align: center;">
              <a href="${process.env.CLIENT_URL}/user/water" style="background: #1b6ca8; color: white; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block;">View in Portal →</a>
            </div>
          </div>
          <div style="background: #f8fafc; padding: 16px 28px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #aaa;">Smart Municipal Corporation • Ahmedabad, Gujarat</p>
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden;">
          ...
          <div style="background: white; padding: 28px; text-align: center;">
            ...
            <p style="font-size: 14px; color: #555;">Total: <strong style="color: #f57c00;">${totalPoints} pts</strong> = ₹${Math.floor(totalPoints / 100)} tax discount</p>
            <a href="${process.env.CLIENT_URL}/user/points" style="background: #f57c00; color: white; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block;">View My Points →</a>
          </div>
          <div style="background: #f8fafc; padding: 16px 28px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #aaa;">Smart Municipal Corporation • Ahmedabad, Gujarat</p>
          </div>
